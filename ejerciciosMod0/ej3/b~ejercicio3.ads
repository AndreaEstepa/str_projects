...
package Ada_Main is
   ...
   u00001 : constant Integer := 16#6F234EA4#;
   ...
   u00042 : constant Integer := 16#32AE65C8#;
   u00043 : constant Integer := 16#501968FA#;
   u00044 : constant Integer := 16#454E0FB3#;
   u00045 : constant Integer := 16#7400AB3D#;
   u00046 : constant Integer := 16#5232DFDC#;
   u00047 : constant Integer := 16#428A28C5#;
   u00048 : constant Integer := 16#6A6F4396#;
   u00049 : constant Integer := 16#09BADB05#;
   u00050 : constant Integer := 16#60C36E5C#;
   u00051 : constant Integer := 16#7202CBD1#;
   u00052 : constant Integer := 16#0F7193E3#;
   u00053 : constant Integer := 16#16952D8B#;
   u00054 : constant Integer := 16#325DDA1F#;
   u00055 : constant Integer := 16#644FBE04#;
   u00056 : constant Integer := 16#4F9B5906#;
   u00057 : constant Integer := 16#260306DA#;
   u00058 : constant Integer := 16#54AB61A8#;
   u00059 : constant Integer := 16#6371166A#;
   u00060 : constant Integer := 16#3DEC36D4#;
   u00061 : constant Integer := 16#7EF5B3F5#;
   u00062 : constant Integer := 16#21F7877D#;
   u00063 : constant Integer := 16#0D83A3EA#;
   u00064 : constant Integer := 16#0388ABD4#;
   u00065 : constant Integer := 16#0B97C6BF#;
   u00066 : constant Integer := 16#34B32999#;
   u00067 : constant Integer := 16#4F0184F2#;
   u00068 : constant Integer := 16#0A0669D8#;
   u00069 : constant Integer := 16#26610831#;
   u00070 : constant Integer := 16#3C88F424#;
   u00071 : constant Integer := 16#7C25DE96#;
   u00072 : constant Integer := 16#65CAA177#;
   u00073 : constant Integer := 16#5F4E7864#;
   u00074 : constant Integer := 16#03F36D98#;
   u00075 : constant Integer := 16#175F872B#;
   u00076 : constant Integer := 16#1D4F93E8#;
   u00077 : constant Integer := 16#30B2EC3D#;
   u00078 : constant Integer := 16#34054F96#;
   u00079 : constant Integer := 16#66F773CD#;
   u00080 : constant Integer := 16#20A8E82B#;
   u00081 : constant Integer := 16#1CBC39CD#;
   u00082 : constant Integer := 16#63B302E3#;
   u00083 : constant Integer := 16#1307539C#;
   u00084 : constant Integer := 16#61897F59#;
   u00085 : constant Integer := 16#3B9DA6D5#;
   u00086 : constant Integer := 16#2DF1D194#;
   u00087 : constant Integer := 16#61E757F8#;
   u00088 : constant Integer := 16#53842B76#;
   u00089 : constant Integer := 16#4271AE2E#;
   u00090 : constant Integer := 16#736E0B75#;
   u00091 : constant Integer := 16#080C3AA1#;
   u00092 : constant Integer := 16#1120FB80#;
   u00093 : constant Integer := 16#77F167EF#;
   u00094 : constant Integer := 16#7BB26C80#;
   u00095 : constant Integer := 16#2E257CBC#;
   u00096 : constant Integer := 16#403EA0CF#;
   u00097 : constant Integer := 16#259E043B#;
   u00098 : constant Integer := 16#0357E00A#;
   u00099 : constant Integer := 16#02301BD8#;
   u00100 : constant Integer := 16#165E2B21#;
   ...
   pragma Export (C, u00042, "system__img_realB");
   pragma Export (C, u00043, "system__img_realS");
   pragma Export (C, u00044, "system__fat_llfS");
   pragma Export (C, u00045, "system__img_lluB");
   pragma Export (C, u00046, "system__img_lluS");
   pragma Export (C, u00047, "system__img_unsB");
   pragma Export (C, u00048, "system__img_unsS");
   pragma Export (C, u00049, "system__powten_tableS");
   pragma Export (C, u00050, "kernel__threadsB");
   pragma Export (C, u00051, "kernel__threadsS");
   pragma Export (C, u00052, "kernel__memoryB");
   pragma Export (C, u00053, "kernel__memoryS");
   pragma Export (C, u00054, "kernel__threads__protectionB");
   pragma Export (C, u00055, "kernel__threads__protectionS");
   pragma Export (C, u00056, "kernel__cpu_primitivesB");
   pragma Export (C, u00057, "kernel__cpu_primitivesS");
   pragma Export (C, u00058, "system__machine_codeS");
   pragma Export (C, u00059, "kernel__threads__queuesB");
   pragma Export (C, u00060, "kernel__threads__queuesS");
   pragma Export (C, u00061, "kernel__timeB");
   pragma Export (C, u00062, "kernel__timeS");
   pragma Export (C, u00063, "kernel__interruptsB");
   pragma Export (C, u00064, "kernel__interruptsS");
   pragma Export (C, u00065, "ada__finalization__list_controllerB");
   pragma Export (C, u00066, "ada__finalization__list_controllerS");
   ...
   pragma Export (C, u00079, "system__finalization_implementationB");
   pragma Export (C, u00080, "system__finalization_implementationS");
   ...
   pragma Export (C, u00088, "kernel__threads__atcbB");
   pragma Export (C, u00089, "kernel__threads__atcbS");
   pragma Export (C, u00090, "system__os_interfaceB");
   pragma Export (C, u00091, "system__os_interfaceS");
   pragma Export (C, u00092, "system__os_primitivesB");
   pragma Export (C, u00093, "system__os_primitivesS");
   ...
   pragma Export (C, u00098, "interfacesS");
   pragma Export (C, u00099, "interfaces__cB");
